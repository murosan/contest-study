...
(async () => {
  ...
  caseRepo.save("b_a", await getCases(config.beginner.a));
  caseRepo.save("b_b", await getCases(config.beginner.b));
  caseRepo.save("b_c", await getCases(config.beginner.c));
  caseRepo.save("b_d", await getCases(config.beginner.d));
